...
fps = 90  # Atualizacao de frames por segundo
ani = 6  # Ciclo de animacao
ani_soco = 5  # Ciclo de animacao do soco
steps = 4  # Pixels a serem andados com cada movimento
...
class Jogo():
    ...
    def __init__(self, player):
        ...
        self.img_andar = pygame.image.load(os.path.join('images', 'andar.png'))  # Pegar imagem da grama
        # (DEIXEI SEPARADO MESMO SENDO IGUAL PORQUE ACHO QUE A GENTE PODE FAZER UM BLOCO DIFERENTE QUE FICA POR CIMA DO CHAO)
        self.img_dna_chao = pygame.image.load(os.path.join('images', 'chao_dna_fundo.png'))  # Pegar imagem da terra
    ...
    def movimento_camera(self, true_scroll):
        ...
        self.true_scroll[1] = -screen.get_height() + (25 * len(self.data))  # Movimento em y travado fixo em  - altura da tela + numero de linhas pela sua altura
    ...
    def gravidade(self):
        ...
        if player.tipo_colisao['baixo']:  # Se colisao por baixo = true
...
class Fundo():
    ...
    def desenhar_fundo(self):
        self.fundoX -= 1  # Velocidade do fundo 1
        self.fundoX2 -= 1  # Velocidade do fundo 2
